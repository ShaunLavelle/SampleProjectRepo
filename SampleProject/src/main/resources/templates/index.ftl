	...
	<nav class="navbar-wrapper navbar-default" role="navigation">
		<div class="container">
			  <div class="navbar-header">
				...
				<a class="navbar-brand site-name" href="#top"><h3 style="margin-top:0px; color:orange">Sample Project</h3></a>
			  </div>
...
<!-- /.download section -->
<div id="download">
	<div class="action fullscreen parallax" style="background-image:url('images/coast.jpg');" data-img-width="2000" data-img-height="1333" data-diff="100">
		<div class="overlay">
			<div class="container">
...
<div id="testi">
	<div class="container">
		<div class="text-center">
			<h2 class="wow fadeInLeft">REVIEWS</h2>
...
<footer id="footer">
	<div class="container">
		<div class="col-sm-4 col-sm-offset-4">
			...
			<div class="text-center wow fadeInUp" style="font-size: 14px;">Copyright Sample Project 2016 - Template by <a href="#">Shaun Inc</a></div>
